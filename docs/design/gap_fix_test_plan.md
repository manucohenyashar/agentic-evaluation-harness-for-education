...
| CT-INTEG-18 | perf | Median `verify` ≤ 2 ms per cell (4 pages, ≤ 20 spans, E1) | ops, PERF-06 | |
...
| PERF-06 | **Red** on that branch: integrity 2.25% against 1% | FR-INTEG-11/12, NFR-INTEG-01 amended | re-specified, turns green | Measured as gate time excluding test-double reads; threshold unchanged at < 1% |
