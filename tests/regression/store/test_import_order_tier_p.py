...
for Cohort, `aeh.det` for Tier D — so the
chain an
...
`aeh.agg` joining the lists and owning the tail. #101's `grade_submission_grade_key`
is the sixth — Cohort 16→17, `aeh.grade` joining the lists and owning the tail.)
