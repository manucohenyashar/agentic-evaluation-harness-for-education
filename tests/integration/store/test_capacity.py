...
def test_tc_store_19_a_clean_environment_needs_only_the_data_dir(tmp_data_dir, tmp_path):
    ...
    child = (
        ...
        "# Cohort's last migration (16, #92), aeh.judge the one before it (14, #78) and\n"
        "# aeh.integ Durable's (5, #73), so the convention's line has nine modules now.\n"
        "import aeh.agg, aeh.det, aeh.extract, aeh.ingest, aeh.integ, aeh.judge, aeh.orch, aeh.pkg, aeh.synth  # noqa: E401\n"
