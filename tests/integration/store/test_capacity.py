...
def test_tc_store_19_a_clean_environment_needs_only_the_data_dir(tmp_data_dir, tmp_path):
    ...
    child = (
        ...
        "# imports every contributing module before the first open (#234). aeh.grade owns\n"
        "# Cohort's last migration (17, #101), so the convention's line has nine modules now.\n"
        "import aeh.agg, aeh.det, aeh.extract, aeh.grade, aeh.ingest, aeh.judge, aeh.orch, aeh.pkg, aeh.synth  # noqa: E401\n"
