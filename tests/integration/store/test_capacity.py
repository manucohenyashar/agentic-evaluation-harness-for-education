...
def test_tc_store_19_a_clean_environment_needs_only_the_data_dir(tmp_data_dir, tmp_path):
    ...
    child = (
        ...
        "# imports every contributing module before the first open (#234). aeh.orch owns\n"
        "# Cohort's migration 12 (#61) and aeh.synth the last one (13, #97), so the\n"
        "# convention's line has six modules now.\n"
        "import aeh.det, aeh.extract, aeh.ingest, aeh.orch, aeh.pkg, aeh.synth  # noqa: E401\n"
