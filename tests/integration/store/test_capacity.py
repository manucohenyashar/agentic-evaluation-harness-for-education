...
def test_tc_store_19_a_clean_environment_needs_only_the_data_dir(tmp_data_dir, tmp_path):
    ...
    child = (
        ...
        "# Cohort's last migration (14, #78) and aeh.integ Durable's (5, #73), so the\n"
        "# convention's line has eight modules now.\n"
        "import aeh.det, aeh.extract, aeh.ingest, aeh.integ, aeh.judge, aeh.orch, aeh.pkg, aeh.synth  # noqa: E401\n"
