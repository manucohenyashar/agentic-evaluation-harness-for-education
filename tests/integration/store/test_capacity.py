...
"# imports every contributing module before the first open (#234). aeh.grade owns\n"
        "# Cohort's last migration (19, #103; #101's was 18), aeh.judge the one before it (17, #80) and\n"
        "# aeh.grade Durable's (7, #103; #110's was 6), so the convention's line has eleven modules now.\n"
