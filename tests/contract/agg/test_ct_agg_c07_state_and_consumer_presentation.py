...
- **the consumer presentation differential** (the case's rung-3 limb, writtenahead on
  all three consumers — M-REVIEW's param runs since #108's landing; M-GRADE #101 and
  M-CONSOLE #123 stay red by design until their stories land): the breaker path
...
@pytest.mark.parametrize(
    ...
    [
        # M-REVIEW landed at #108 and its param runs; the other two consumers
        # are unlanded and stay red by design until their stories land.
