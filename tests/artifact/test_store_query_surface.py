...
KNOWN_EXECUTE_SITES: frozenset[str] = frozenset({
    ...
    # class and the COMPLETE_SCHEMA_VERSIONS pin, both above the first site) and again with
    # #269's _VersionOrderedRegistry; the sites are the same statements as before.
    "aeh.store:1796",
    "aeh.store:2575",
})
