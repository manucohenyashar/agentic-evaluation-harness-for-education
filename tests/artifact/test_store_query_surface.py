...
#: above it, and again (778 -> 1284) when #13 moved the FR-STORE-12 name vocabulary, the
#: guard parser, the purge statement registry and the location-permission helpers above it —
...
KNOWN_EXECUTE_SITES: frozenset[str] = frozenset({"aeh.store:1284"})
